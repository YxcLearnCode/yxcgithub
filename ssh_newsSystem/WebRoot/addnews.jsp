   ...
   <br/>
	<div class="col-lg-3">
		<ul class="nav nav-pills nav-stacked">
			...
			<li class="active"><a href="addnews.jsp">发布新闻</a></li>
			<li><a href="developerinfo.jsp">开人人员介绍</a></li>			
			<li><a href="logoutsuccess.jsp">注销</a></li>
		</ul>
	</div>
	<div class="col-lg-9">
		<form class="form-horizontal" action="addnews" method="post">
		</br>
		  <div class="form-group">
		    <label class="col-sm-2 control-label">标题：</label>
		   
		    <div class="col-sm-6">
		      <input name="title" type="text" class="form-control" id="title" placeholder="新闻标题">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-6">
		      <input type="radio" name="category" value="1" /> 时政
		      <input type="radio" name="category" value="2" /> 科技
		      <input type="radio" name="category" value="3" /> 娱乐
		      <input type="radio" name="category" value="4" /> 体育
		      <input type="radio" name="category" value="5" /> 游戏
		      <input type="radio" name="category" value="6" /> 财经
		    </div>
		  </div>
		  <div class="form-group">
		    ...
		    <div class="col-sm-6">
		      <textarea class="form-control" style="height:200px;" id="newscontent" name="content" placeholder="新闻内容">
		      </textarea>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-2">
		      <button type="submit" class="btn btn-primary btn-block">发布新闻</button>
		    </div>
		  </div>
		</form>
	</div>
